...
var Button = React2.forwardRef(function(_param, ref) {
    ...
    }, props), isLoading && /* @__PURE__ */ React2.createElement(Loader2, {
...
import { Calendar as Calendar2, ChevronDown as ChevronDown2, ChevronLeft as ChevronLeft2, ChevronRight as ChevronRight2, Download, Search as Search2 } from "lucide-react";
...
function Calendar(param) {
    ...
    var _useState = _sliced_to_array(useState(selectedDate), 2), viewDate = _useState[0], setViewDate = _useState[1];
...
var SelectTrigger = React6.forwardRef(function(_param, ref) {
    ...
    return /* @__PURE__ */ React6.createElement(SelectPrimitive.Trigger, _object_spread({
        ...
        asChild: true
    }, /* @__PURE__ */ React6.createElement(ChevronDown, {
...
var SelectScrollUpButton = React6.forwardRef(function(_param, ref) {
    ...
    }, props), /* @__PURE__ */ React6.createElement(ChevronUp, {
        className: "h-4 w-4"
    }));
});
...
var SelectScrollDownButton = React6.forwardRef(function(_param, ref) {
    ...
    return /* @__PURE__ */ React6.createElement(SelectPrimitive.ScrollDownButton, _object_spread({
        ref: ref,
        className: cn("flex cursor-default items-center justify-center py-1", className)
    }, props), /* @__PURE__ */ React6.createElement(ChevronDown, {
        className: "h-4 w-4"
    }));
});
...
var SelectItem = React6.forwardRef(function(_param, ref) {
    ...
    }, /* @__PURE__ */ React6.createElement(SelectPrimitive.ItemIndicator, null, /* @__PURE__ */ React6.createElement(Check2, {
        className: "h-4 w-4"
...
var MultiselectFilter = function(param) {
    ...
    var _useState21 = _sliced_to_array(useState2(""), 2), activeCategory = _useState21[0], setActiveCategory = _useState21[1];
    var _useState22 = _sliced_to_array(useState2([]), 2), categories = _useState22[0], setCategories = _useState22[1];
    var _useState23 = _sliced_to_array(useState2([]), 2), options = _useState23[0], setOptions = _useState23[1];
    useEffect(function() {
        var _;
    ...
    }, "Clear All", /* @__PURE__ */ React.createElement(X, {
...
function CustomDataTable(param) {
    ...
    var _useState3 = _sliced_to_array(useState3(""), 2), globalFilter = _useState3[0], setGlobalFilter = _useState3[1];
    var _useState31 = _sliced_to_array(useState3({}), 2), rowSelection = _useState31[0], setRowSelection = _useState31[1];
    var _useState32 = _sliced_to_array(useState3({}), 2), columnVisibility = _useState32[0], setColumnVisibility = _useState32[1];
    var _useState33 = _sliced_to_array(useState3(/* @__PURE__ */ new Date()), 2), date = _useState33[0], setDate = _useState33[1];
    ...
    return /* @__PURE__ */ React.createElement("div", {
    ...
    }, formatDate(date) || "Select date", /* @__PURE__ */ React.createElement(Calendar2, {
        ...
        variant: "outline",
        className: "border-gray-300 text-gray-700 hover:bg-gray-50 hover:text-gray-900"
    }, "More Filters", /* @__PURE__ */ React.createElement(ChevronDown2, {
        className: "ml-2 h-4 w-4"
    }))), /* @__PURE__ */ React.createElement(PopoverContent, {
        className: "w-auto p-0",
        align: "end"
        ...
        return /* @__PURE__ */ React.createElement(TableRow, {
            ...
            }, header.isPlaceholder ? null : /* @__PURE__ */ React.createElement("div", null, flexRender(header.column.columnDef.header, header.getContext())));
        }));
    ...
    }, /* @__PURE__ */ React.createElement(ChevronLeft2, {
        className: "h-4 w-4"
    })), Array.from({
    ...
    }, /* @__PURE__ */ React.createElement(ChevronRight2, {
        className: "h-4 w-4"
    }))), /* @__PURE__ */ React.createElement("div", {
        className: "flex items-center gap-2"
    }, /* @__PURE__ */ React.createElement("span", {
...
var DialogContent = React8.forwardRef(function(_param, ref) {
    ...
    }, /* @__PURE__ */ React8.createElement(XCircle, {
        className: "h-4 w-4"
...
var DropdownMenuSubTrigger = React9.forwardRef(function(_param, ref) {
    ...
    }, props), children, /* @__PURE__ */ React9.createElement(ChevronRight3, {
        className: "ml-auto"
    }));
});
...
var DropdownMenuCheckboxItem = React9.forwardRef(function(_param, ref) {
    ...
    return /* @__PURE__ */ React9.createElement(DropdownMenuPrimitive.CheckboxItem, _object_spread({
        ...
        className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center"
    }, /* @__PURE__ */ React9.createElement(DropdownMenuPrimitive.ItemIndicator, null, /* @__PURE__ */ React9.createElement(Check3, {
        className: "h-4 w-4"
    }))), children);
});
...
var DropdownMenuRadioItem = React9.forwardRef(function(_param, ref) {
    ...
    return /* @__PURE__ */ React9.createElement(DropdownMenuPrimitive.RadioItem, _object_spread({
        ...
        className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center"
    }, /* @__PURE__ */ React9.createElement(DropdownMenuPrimitive.ItemIndicator, null, /* @__PURE__ */ React9.createElement(Circle, {
...
var AdminCard = function(param) {
    ...
    return /* @__PURE__ */ React11.createElement(Link2, {
        href: href,
        ...
        className: "mb-2"
    }, icon), /* @__PURE__ */ React11.createElement("h3", {
        className: "font-bold"
...
import { Bell, CircleDollarSign, FileBox, FileSpreadsheet, LayoutGrid, ListChecks, Mail, Palette, Tags, Users } from "lucide-react";
...
var ReusableListIcon = function() {
    return /* @__PURE__ */ React.createElement(ListChecks, {
        className: "h-5 w-5 text-blue-600"
    });
};
...
var RolesIcon = function() {
    return /* @__PURE__ */ React.createElement(FileSpreadsheet, {
        className: "h-5 w-5 text-blue-600"
    });
};
...
var ModulesIcon = function() {
    return /* @__PURE__ */ React.createElement(FileBox, {
        className: "h-5 w-5 text-blue-600"
    });
};
...
var BusinessObjectIcon = function() {
    return /* @__PURE__ */ React.createElement(CircleDollarSign, {
        className: "h-5 w-5 text-blue-600"
    });
};
